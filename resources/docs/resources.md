...
Estes são os recursos utilizados no desenvolvimento do projeto.

## Desenvolvimento

Para desenvolvimento foram utilizadas diversas ferramentas:

- **Visual Studio Community**: Desenvolvimento C#.
- **Visual Studio Code**: Desenvolvimento das demais linguagens.
- **pgAdmin**: Design e manipulação do banco de dados.
